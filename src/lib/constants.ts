...
// API Configuration
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://51.77.195.224:3001';
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'http://51.77.195.224:3000';
