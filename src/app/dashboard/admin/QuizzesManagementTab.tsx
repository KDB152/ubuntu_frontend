        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
          <div className="p-6 border-b border-white/20">
            <h2 className="text-xl font-bold text-white flex items-center">
              ...
              Résultats des quiz ({attempts.length})
            </h2>
          </div>
          ...
          <div className="overflow-x-auto">
            ...
            {attempts.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-blue-200 text-lg">Aucun résultat disponible</p>
                <p className="text-blue-300 text-sm">Les résultats apparaîtront ici une fois que les étudiants auront commencé à passer les quiz</p>
              </div>
            )}
          </div>
        </div>
